...
import { deleteOrder, getAllFinishOrders, getAllSampleOrders } from '@/app/action/orders-action';
...
const FinishCards = () => {
    ...
    const { data: allSampleOrders, error, isLoading, refetch } = useQuery({
        queryKey: ['allFinishOrders'],
        queryFn: getAllFinishOrders, // No user ID required here
    });
